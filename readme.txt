...
microsoft-band-1.3.10929.1.jar – the Java jar library for the Microsoft Band SDK. 
                               The file name contains the version of the SDK release.

microsoft-band-1.3.10929.1-docs.zip - file containing the java documentation for microsoft-band-{version}.jar
...
To use the microsoft-band-1.3.10929.1.jar in your own project:
